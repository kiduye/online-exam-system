...
//   FaClipboardCheck,
// } from "react-icons/fa";
// import { MdDashboard, MdMenuBook, MdQuiz, MdFileUpload } from "react-icons/md";
...
//   const Menus = [
    ...
    // { title: "Manage Courses", icon: <MdMenuBook />, path: "manage/course"},
    // { title: "Manage Question", icon: < MdQuiz />, path: "manage/question"},
    // { title: "Manage Materials", icon: <MdFileUpload />, path: "manage/material"},
//     // { title: "Announcement", icon: <FaBullhorn />, path: "announcement" },
//     // { title: "Exam Schedule", icon: <FaCalendarAlt />, path: "schedules" },
//     // { title: "Release Exam Result", icon: <FaClipboardCheck />, path: "release-exam-result" },
//   ];
...
//         <FiMenu
//           className={`text-2xl ${sidebarOpen ? "text-blue" : "text-gray-800"}`}
...
//               <li
//                 key={index}
//                 className={`flex items-center p-2 rounded-md cursor-pointer hover:bg-light-white ${
//                   sidebarOpen ? "text-white hover:bg-gray-700" : "text-blue-700/95 hover:bg-light-white"
...
//                     pathname === menu.path ? "text-blue-500" : sidebarOpen ? "text-gray-100 hover:text-gray-300" : "text-gray-500 hover:text-gray-700"
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const Menus = [
    // { title: "Dashboard", icon: <MdDashboard />, path: "overview" },
    { title: "Manage Course Module", icon: <MdMenuBook />, path: "manage/course"},
    { title: "Manage Question", icon: < MdQuiz />, path: "manage/question"},
    { title: "Manage Materials", icon: <MdFileUpload />, path: "manage/material"},
  ];
