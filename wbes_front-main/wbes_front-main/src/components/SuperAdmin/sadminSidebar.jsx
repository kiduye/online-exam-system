...
//   const Menus = [
    ...
    // { title: "Manage Admins", icon: <FaUsers />, path: "manage/admin"},
    // { title: "Manage Announcement ", icon: < FaBullhorn />, path: "manage/announcement"},
    // { title: "Manage Dep'ts", icon: <FaBuilding />, path: "manage/department"},
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const Menus = [
    { title: "Dashboard", icon: <MdDashboard />, path: "overview" },
    { title: "Manage Dep'ts", icon: <FaBuilding />, path: "manage/department"},
     { title: "Manage EnrollmentType ", icon: < FaBullhorn />, path: "enroll"},
    { title: "Manage Admins", icon: <FaUsers />, path: "manage/admin"},
    { title: "Manage Announcement ", icon: < FaBullhorn />, path: "manage/announcement"},
